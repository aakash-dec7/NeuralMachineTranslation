...
from src.nmt.utils.utils import get_package_info
from src.nmt.entity.entity import ModelEvaluationConfig
...
class ModelEvaluation:
    ...
    def _log_results(self, avg_bleu_score: float) -> None:
        ...
        (Path(self.config.metrics_path) / "metrics.json").write_text(
