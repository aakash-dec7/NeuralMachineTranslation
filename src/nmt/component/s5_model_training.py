...
from src.nmt.component.model import Model
from src.nmt.entity.entity import ModelTrainingConfig
from src.nmt.config.configuration import ConfigurationManager
from src.nmt.utils.utils import load_checkpoint, save_checkpoint
...
class ModelTraining:
    ...
    def _initialize_model(self) -> Model:
        ...
        return Model(config=ConfigurationManager().get_model_config()).to(self.device)
